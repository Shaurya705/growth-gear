...
const mockQueries = [
  {
    id: "1",
    title: "netM module not loading properly",
    description: "The netM module fails to load when accessed from the dashboard.",
    status: "New",
  ...
  {
    id: "2",
    title: "netM data export failing",
    description: "When trying to export data from netM, the process fails with an error.",
    status: "In Progress",
  ...
  {
    id: "3",
    title: "netM integration issue with third-party API",
    description: "The netM module is not properly integrating with the third-party API.",
    status: "Resolved",
...
export default function NetMQueryDetailsPage() {
      ...
      <DashboardShell>
        <div className="flex h-[50vh] items-center justify-center">
          <div className="text-center">
            ...
            <Button variant="outline" className="mt-4" onClick={() => router.push("/dashboard/netm-queries")}>
              Back to netM Queries
            </Button>
          </div>
        </div>
      </DashboardShell>
  ...
  return (
    <DashboardShell>
      <DashboardHeader heading={query.title} text={`netM Query ID: ${query.id}`}>
        <div className="flex items-center gap-2">
          <Button variant="outline" onClick={() => router.push("/dashboard/netm-queries")}>
            Back to netM Queries
          </Button>
        </div>
      </DashboardHeader>
        ...
        <TabsContent value="details" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Details about this netM query</CardDescription>
            </CardHeader>
