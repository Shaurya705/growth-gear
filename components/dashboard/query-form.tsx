...
export function QueryForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      toast({
        title: "Query created!",
        description: "Your query has been successfully created.",
      })
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Enter the title of your query" {...field} />
              </FormControl>
              <FormDescription>A brief title describing the issue or request.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Provide details about your query" className="min-h-[150px]" {...field} />
              </FormControl>
              <FormDescription>Detailed information about the issue or request.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>This query is for the General module.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              ...
              <FormDescription>
                The user assigned to handle this query. You can select an existing user or enter a custom name.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <div className="flex gap-4">
          ...
          <Button type="button" variant="outline" onClick={() => router.push("/dashboard/queries")}>
            Cancel
          </Button>
        </div>
      </form>
